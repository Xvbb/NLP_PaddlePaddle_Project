...
parser.add_argument("--language", type=str, default="Chinese", help="The language of dataset")
...
def do_evaluate(model, data_loader, with_pooler=False):
    ...
    for batch in data_loader:
        ...
        title_cls_embedding = model.get_pooled_embedding(
            title_input_ids, title_token_type_ids, with_pooler=with_pooler)
...
def do_train():
    ...
    if args.language == "Chinese":
        ...
        if args.pretrained_model == "ernie":
            ...
            pretrained_model_path = 'ernie-2.0-en'
        elif args.pretrained_model == "roberta":
            pretrained_model_path = 'roberta-base-squad2'
